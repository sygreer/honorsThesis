...
\subsection{Iterative method for calculating the smoothing radius: A modification}
        ...
        \multiplot{2}{freqdif,freqdif-filt5}{width=0.47\columnwidth}{Difference in local frequencies
...
\inputdir{vecta}
        ...
        \multiplot{2}{before,after}{width=0.65\columnwidth}{Interleaved PP and warped SS traces before
